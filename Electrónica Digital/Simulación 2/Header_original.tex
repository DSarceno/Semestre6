...
\multirow{4}{2.3cm}{\includegraphics[scale=0.13]{/home/diego/Documents/Licenciatura/LatexBasic/ECFM.pdf}} & Universidad de San Carlos de Guatemala  & & & \multirow{4}{4cm}{\hfill \includegraphics[scale=0.082]{/home/diego/Documents/Licenciatura/LatexBasic/USAC.pdf}}\tabularnewline
...
\begin{tabulary}{21cm}{p{5cm}p{7cm}p{9cm}}
    \hfill & \huge{\scshape{Simulacion 2}} & \hfill
\end{tabulary}
{\hrule height 1.5pt} 
\vspace{0.5cm}
